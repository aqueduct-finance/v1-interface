...
function NavBar() {
    ...
    return (
        <motion.div
            className={`max-w-screen-2xl sticky top-0 left-0 flex w-full text-aqueductBlue p-4 lg:px-8 lg:pt-6 lg:pb-4 z-50 backdrop-blur-xl pixel-blur bg-aqueBg/40 overflow-hidden ${
